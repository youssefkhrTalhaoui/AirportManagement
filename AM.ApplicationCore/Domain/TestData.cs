...
namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
        ...
        // Staffs
        public static Staff captain = new Staff { FirstName = "captain", LastName = "captain", EmailAddress = "captain.captain@gmail.com", BirthDate = new DateOnly(1965, 01, 01), EmployementDate = new DateOnly(1999, 01, 01), Salary = 99999 };
        public static Staff hostess1 = new Staff { FirstName = "hostess1", LastName = "hostess1", EmailAddress = "hostess1.hostess1@gmail.com", BirthDate = new DateOnly(1995, 01, 01), EmployementDate = new DateOnly(2020, 01, 01), Salary = 999 };
        public static Staff hostess2 = new Staff { FirstName = "hostess2", LastName = "hostess2", EmailAddress = "hostess2.hostess2@gmail.com", BirthDate = new DateOnly(1996, 01, 01), EmployementDate = new DateOnly(2020, 01, 01), Salary = 999 };
        // Travellers
        public static Traveller traveller1 = new Traveller { FirstName = "traveller1", LastName = "traveller1", EmailAddress = "traveller1.traveller1@gmail.com", BirthDate = new DateOnly(1980, 01, 01), HealthInformation = "no troubles", Nationality = "American" };
        public static Traveller traveller2 = new Traveller { FirstName = "traveller2", LastName = "traveller2", EmailAddress = "traveller2.traveller2@gmail.com", BirthDate = new DateOnly(1981, 01, 01), HealthInformation = "Some troubles", Nationality = "French" };
        ...
        public static Traveller traveller4 = new Traveller { FirstName = "traveller4", LastName = "traveller4", EmailAddress = "traveller4.traveller4@gmail.com", BirthDate = new DateOnly(1983, 01, 01), HealthInformation = "Some troubles", Nationality = "American" };
        public static Traveller traveller5 = new Traveller { FirstName = "traveller5", LastName = "traveller5", EmailAddress = "traveller5.traveller5@gmail.com", BirthDate = new DateOnly(1984, 01, 01), HealthInformation = "Some troubles", Nationality = "Spanish" };
        // Flights
